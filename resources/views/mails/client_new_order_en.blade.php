                                                                            ...
                                                                            <table class="wrapper" role="module" data-type="image" border="0" cellpadding="0" cellspacing="0" width="100%" style="table-layout: fixed;">
                                                                                <tr>
                                                                                    <td style="font-size:6px;line-height:10px;padding:15px; background-color: #fff;" valign="top" align="center">
                                                                                        <img class="max-width" border="0" style="display:block;color:#000000;text-decoration:none;font-family:Helvetica, arial, sans-serif;font-size:16px;max-width:38% !important;width:160px;height:50px !important;float: left;" src="{{asset('assets/img/mails/Logo.png')}}"  width="600">
                                                                                    </td>
                                                                                </tr>
                                                                            </table>
                                                                            <table class="wrapper" role="module" data-type="image" border="0" cellpadding="0" cellspacing="0" width="100%" style="table-layout: fixed;">
                                                                            ...
                                                                            <table class="module" role="module" data-type="text" border="0" cellpadding="0" cellspacing="0" width="100%" style="table-layout: fixed;">
                                                                                <tr>
                                                                                    <td style="background-color:#F8F8FB;padding:25px 0px 10px 0px;line-height:22px;text-align:inherit;" height="100%" valign="top" bgcolor="#39437C">
                                                                                        <div style="text-align: center;color:#29294D;font-size:24px"><strong>
                                                                                                <span class="author-d-1gg9uz65z1iz85zgdz68zmqkz84zo2qovvuiz70zivz70zz82zpz73zis3z79zz89zlz65zsvjjbhz85zz70zz81ztz86zhuz89z">{{ trans('hello') }}</span>
                                                                                                <span class="author-d-1gg9uz65z1iz85zgdz68zmqkz84zo2qovvuiz70zivz70zz82zpz73zis3z79zz89zlz65zsvjjbhz85zz70zz81ztz86zhuz89z s-lsquo"></span>
                                                                                                <span class="author-d-1gg9uz65z1iz85zgdz68zmqkz84zo2qoxwz83zz71z2z84ztln7xjz86zz79z2z88zaz84zmz71zz122zz90zs1ez87zz70zsz75zz87zlz89zh-lsquo">"</span><span class="author-d-1gg9uz65z1iz85zgdz68zmqkz84zo2qovvuiz70zivz70zz82zpz73zis3z79zz89zlz65zsvjjbhz85zz70zz81ztz86zhuz89z h-lsquo">{{ $user['first_name']." ".$user['last_name'] }}</span>
                                                                                                <span class="author-d-1gg9uz65z1iz85zgdz68zmqkz84zo2qoxwz83zz71z2z84ztln7xjz86zz79z2z88zaz84zmz71zz122zz90zs1ez87zz70zsz75zz87zlz89z">Solution</span><span class="author-d-1gg9uz65z1iz85zgdz68zmqkz84zo2qoxwz83zz71z2z84ztln7xjz86zz79z2z88zaz84zmz71zz122zz90zs1ez87zz70zsz75zz87zlz89z h-lsquo">"</span></strong>
                                                                                        </div>
                                                                                    </td>
                                                                                </tr>
                                                                            </table>
                                                                            <table class="module" role="module" data-type="code" border="0" cellpadding="0" cellspacing="0" width="100%" style="table-layout: fixed;">
                                                                                <tr>
                                                                                    <td height="100%" valign="top">
                                                                                        <div class="col-lg-12" style="background-color:#F8F8FB;padding:20px">
                                                                                            <div style="text-align: left;">
                                                                                                <span style="font-family: 'Sarabun', sans-serif; line-height:20px;">
                                                                                                    <span style="color:#29294D;">{{ trans('order_submitted_successfully_message') }}</span>
                                                                                                </span>
                                                                                            </div>
                                                                                            <div style="text-align: left;">&nbsp;</div>
                                                                                            <div style="text-align: left;">
                                                                                                <span style="font-family: 'Sarabun', sans-serif;line-height:20px;">
                                                                                                    <span style="color: #7E7E94;font-weight: 600;line-height:50px;">{{ trans('order_id') }}: </span> {{ $order->id }} <br>
                                                                                                </span>
                                                                                            </div>
                                                                                            <div style="text-align: left;">&nbsp;</div>
                                                                                    ...
                                                                                    <td height="100%" valign="top">
                                                                                        <div class="" style="background-color:#D94962;height:20px;padding:20px">
                                                                                            <a href="https://www.playstore.net">
                                                                                                <img style="height:24px;width:24px;margin-right:10px;float:right" src="{{asset('assets/img/mails/playstore.png')}}">
                                                                                            </a>
                                                                                            <a href="https://www.appstore.com">
                                                                                                <img style="height:24px;width:24px;margin-right:10px;float:right" src="{{asset('assets/img/mails/appstore.png')}}">
                                                                                            </a>
                                                                                            <span style="color: #fff;float: right;margin-right: 7px;">{{ trans('available_on') }}</span>
                                                                                        </div>
                                                                                    </td>
                                                                                </tr>
                                                                            </table>
