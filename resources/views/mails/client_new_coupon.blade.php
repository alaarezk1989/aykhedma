                                                                            ...
                                                                            <table class="wrapper" role="module" data-type="image" border="0" cellpadding="0" cellspacing="0" width="100%" style="table-layout: fixed;">
                                                                                <tr>
                                                                                    <td style="font-size:6px;line-height:10px;padding:15px;background-color: #fff;" valign="top" align="center">
                                                                                        ...
                                                                                        <h2 style="float: left;font-size:24px;color: #D94962;">{{ trans('new_coupon') }}</h2>
                                                                                    </td>
                                                                                </tr>
                                                                            </table>
                                                                            <table class="wrapper" role="module" data-type="image" border="0" cellpadding="0" cellspacing="0" width="100%" style="table-layout: fixed;">
                                                                                ...
                                                                                <tr>
                                                                                    <td height="100%" valign="top">
                                                                                        <div class="col-lg-12"
                                                                                            ...
                                                                                            <div style="text-align: right;"><span style="font-family: 'Sarabun',sans-serif; line-height:20px;"><span style="color:#29294D;">{{ trans('new_coupon_message')}} </span></span></div>
                                                                                            <div style="text-align: right;"><span style="font-family: 'Sarabun',sans-serif; line-height:20px;"><span style="color:#29294D;">{{ trans('code')." : ". $coupon['code']}} </span></span></div>
                                                                                            <div style="text-align: right;"><span style="font-family: 'Sarabun',sans-serif; line-height:20px;"><span style="color:#29294D;">{{ trans('coupon_value')." : ". $coupon['value']}} @if($coupon['type'] == \App\Constants\PromotionTypes::PERCENTAGE) % @else {{ trans('egy_pound') }} @endif</span></span></div>
                                                                                            <div style="text-align: right;"><span style="font-family: 'Sarabun',sans-serif; line-height:20px;"><span style="color:#29294D;">{{ trans('expire_date')." ". $coupon['expire_date']}} </span></span></div>
