                                                                                ...
                                                                                <tr>
                                                                                    <td height="100%" valign="top">
                                                                                        <div class="col-lg-12"
                                                                                            ...
                                                                                            <div style="text-align: right;"><span style="font-family: 'Sarabun',sans-serif; line-height:20px;"><span style="color:#29294D;">{{ trans('order_cancelled_successfully_message') }}</span></span></div>
