        ...
        <section class="section">
            ...
            <div class="page-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('admin.product.reviews.index', ['product' => $product->id]) }}" class="text-light-color">{{trans('reviews')}}</a></li>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <form action="{{ route('admin.product.reviews.store',['product'=>$product->id]) }}" method="post">
                                    @csrf
