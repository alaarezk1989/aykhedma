        ...
        <section class="section">
            ...
            <div class="page-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('admin.discounts.index') }}" class="text-light-color">{{trans('discounts')}}</a></li>
                    <li class="breadcrumb-item active" aria-current="page">{{trans('update_discount')}} #{{ $discount->id }}</li>
                </ol>
            </div>
            <!--page-header closed-->
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h4>{{trans('update_discount')}}</h4>
                            </div>
                            <div class="card-body">
                                @include('admin.errors')
                                <form action="{{ route('admin.discounts.update', ['discount' => $discount]) }}" method="post" enctype="multipart/form-data">
                                    @method("PUT")
                                    @csrf
                                            ...
                                            <div
                                                ...
                                                <div class="form-group col-md-4">
                                                    ...
                                                    <input type="text" class="form-control" name="{{ $lang }}[title]"
                                                           value="{{ !old( $lang.'.title') ? $discount->translate($lang)->title : old( $lang.'.title') }}"
                                                           id="title">
                                                </div>
                                        ...
                                        <div class="form-group col-md-4">
                                            <div class="form-group overflow-hidden">
                                                ...
                                                <input type="number" class="form-control" name="value" id="value"
                                                       value="{{ !old('value') ? $discount->value : old('value') }}">
                                            </div>
                                        </div>
                                            ...
                                            <div class="form-group overflow-hidden">
                                                ...
                                                <select name="type" id="type" class="form-control select2 w-100"
                                                    ...
                                                    @foreach(PromotionTypes::getList() as $key => $value)
                                                        <option
                                                            value="{{ $key }}" {{ ($discount->type== $key or old("type") == $key ) ? "selected":null }}>
                                                            {{ $value }}
                                                        </option>
                                                    @endforeach
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <div class="input-group date">
                                                ...
                                                <input type="text" class="form-control pull-right dateFrom"
                                                       name="from_date" id="from" value="{{ !old('from_date') ? $discount->from_date : old('from_date') }}">
                                            </div>
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <div class="input-group date">
                                                ...
                                                <input type="text" class="form-control pull-right dateTo"
                                                       name="to_date" id="to" value="{{ !old('to_date') ? $discount->to_date : old('to_date') }}">
                                            </div>
                                        ...
                                        <div class="form-group col-md-4">
                                            <div class="form-group overflow-hidden">
                                                ...
                                                <input type="number" class="form-control" name="minimum_order_price"
                                                       ...
                                                       value="{{ !old('minimum_order_price') ? $discount->minimum_order_price : old('minimum_order_price') }}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group col-md-4" id="vendor">
                                            <div class="form-group overflow-hidden">
                                                ...
                                                <input type="number" class="form-control" name="usage_no" id="usage_no"
                                                       value="{{ !old('usage_no') ? $discount->usage_no : old('usage_no') }}">
                                            </div>
                                        </div>
                                            ...
                                            <div class="form-group overflow-hidden">
                                                ...
                                                <select name="activity_id" id="activity_id"
                                                    ...
                                                    @foreach($activities as $activity)
                                                        <option
                                                            value="{{ $activity->id }}" {{ (old("activity_id") == $activity->id or $discount->activity_id == $activity->id) ? "selected" : null }}>{{ $activity->name }}</option>
        ...
        function gitActivityVendor(activity, deafultHtml) {
            $.ajax({
                ...
                success: function (data) {
                    ...
                    var i;
                    var old_vendor_id = '{{ !(old("vendor_id")) ? $discount->vendor_id :old("vendor_id")  }}';
                    if(old_vendor_id >0){
        ...
        function gitVendorBranches(vendor, deafultHtml = "") {
            $.ajax({
                ...
                success: function (data) {
                    var html = deafultHtml;
                    var i;
                    var old_branch_id = '{{ !(old("branch_id")) ? $discount->branch_id :old("branch_id") }}';
                    for (i = 0; i < data.length; i++) {
                        html +=
