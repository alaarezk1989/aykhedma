                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                @section("open-form-tag")
                                    <form action="{{ route('admin.branches.update', ['branch' => $branch]) }}" method="post" autocomplete="off">
                                @show
                                            ...
                                            <div class="form-group overflow-hidden">
                                                ...
                                                <select name="vendor_id"  class="form-control select2 w-100" id="vendor_id" >
                                                    ...
                                                    @foreach($vendors as $vendor)
                                                        <option value="{{ $vendor->id }}" {{ old("vendor_id",$branch->vendor_id) == $vendor->id ? "selected":null }}>{{ $vendor->name }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group col-md-4">
                                        <div class="form-group overflow-hidden">
                                            ...
                                            <input class="form-control" type="number" min="1" name="min_order_amount" value="{{ old('min_order_amount', $branch->min_order_amount) }}">
                                        </div>
                                    </div>
                                    <div class="form-group col-md-4">
                                        <div class="form-group overflow-hidden">
                                            <label for="aykhedma_fee">{{trans('aykhedma_fee')}} *</label>
                                            <input class="form-control" type="number" min="1" name="aykhedma_fee" value="{{ old('aykhedma_fee', $branch->aykhedma_fee) }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group col-md-2">
                                        ...
                                        <input type="text" class="form-control" name="lat" id="lat" value="{{ old("lat", $branch->lat) }}" readonly>
                                    </div>

                                    <div class="form-group col-md-2">
                                        <label for="name">{{trans('longitude')}}</label>
                                        <input type="text" class="form-control" name="lng" id="long" value="{{ old("lng",$branch->lng) }}" readonly>
                                    </div>
