                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h4>{{trans('new_cancel_reason')}}</h4>
                            </div>
                            <div class="card-body">
                                @include('admin.errors')
                                <form action="{{ route('admin.cancelReasons.store') }}" method="post">
                                    @csrf
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div class="tab-pane fade {{ $lang == app()->getLocale() ? 'active show': ''}}" id="lang-{{ $lang }}" role="tabpanel" aria-labelledby="home-tab2">
                                            <div class="form-group col-md-4">
                                                ...
                                                <input type="text" class="form-control" name="{{ $lang }}[title]" id="title" value="{{ old($lang.'.title') }}">
                                            </div>
                                        </div>
                                        @endforeach
                                    </div>
