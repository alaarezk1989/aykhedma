        ...
        <section class="section">
            ...
            <div class="page-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('vendor.branches.index') }}" class="text-light-color">{{trans('branches')}}</a></li>
                        ...
                        <div class="card">
                            <div class="card-header">
                                <span class="table-add float-right">
                                    <a href="{{ route('vendor.branch.products.create' , ['branch' => $branch->id,'branchProduct'=>$list]) }}" class="btn btn-icon"><i class="fa fa-plus fa-1x" aria-hidden="true"></i></a>
                                </span>
                                                ...
                                                <td>
                                                    <div class="btn-group dropdown">
                                                        ...
                                                        <div class="dropdown-menu">
                                                            <a class="dropdown-item has-icon" href="{{ route('vendor.branch.products.edit', ['branch' => $branch->id,'branchProduct' => $product->pivot->id]) }}"><i class="fa fa-edit"></i> {{trans('edit')}}</a>
            ...
            <div class="modal fade" id="delete_model_{{ $product->pivot->id }}" tabindex="-1" role="dialog"  aria-hidden="true">
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <form action="{{ route('vendor.branch.products.destroy', ['branch' => $branch->id,'branchProduct' => $product->pivot->id]) }}" method="Post" >
                            @method('DELETE')
                            @csrf
