                        ...
                        <div class="card">
                            <div class="card-header">
                                <span class="table-add float-right">
                                    <a href="{{ route('vendor.branch.zones.create' , ['branch' => $branch->id]) }}" class="btn btn-icon"><i class="fa fa-plus fa-1x" aria-hidden="true"></i></a>
                                </span>
                                                ...
                                                <td>
                                                    <div class="btn-group dropdown">
                                                        ...
                                                        <div class="dropdown-menu">
                                                            <a class="dropdown-item has-icon" href="{{ route('vendor.branch.zones.edit' , ['branch' => $branch->id ,'branchZone' => $zone->pivot->id]) }}"><i class="fa fa-edit"></i> {{trans('edit')}}</a>
            ...
            <div class="modal fade" id="delete_model_{{ $zone->pivot->id }}" tabindex="-1" role="dialog"  aria-hidden="true">
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <form action="{{ route('vendor.branch.zones.destroy', ['branch' => $branch->id ,'branchZone' => $zone->pivot->id]) }}" method="Post" >
                            @method('DELETE')
                            @csrf
