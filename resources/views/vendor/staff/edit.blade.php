        ...
        <section class="section">
            ...
            <div class="page-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">{{trans('update_staff')}}</li>
                </ol>
            </div>
            <!--page-header closed-->
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h4>{{trans('update_staff')}}</h4>
                            </div>
                            <div class="card-body">
                                @include('vendor.errors')
                                <form action="{{ route('vendor.staff.update', ['user' => $user]) }}" method="Post"
                                    ...
                                    <div class="form-group col-md-12 row">
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="text" class="form-control" name="middle_name" id="middle_name"
                                                   value="{{ !(old('middle_name'))? $user->middle_name : old('middle_name') }}">
                                        </div>
                                    ...
                                    <div class="form-group col-md-12 row">
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="text" class="form-control" name="name" id="name"
                                                   value="{{ !(old('name'))? $user->first_name." ".$user->last_name : old('name') }}">
                                        </div>

                                        <div class="form-group col-md-4">
                                            <label for="user_name">{{trans('user_name')}}</label>
                                            <input type="text" class="form-control" name="user_name" id="user_name"
                                                   value="{{ !(old('user_name'))? $user->user_name : old('user_name') }}">
                                        </div>
                                    ...
                                    <div class="form-group col-md-12 row">
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <div class="input-group date">
                                                ...
                                                <input type="text" class="form-control pull-right datepicker" name="birthdate" id="birthdate"
                                            ...
                                            <div class="input-group">
                                                <div class="col-xl-6 col-lg-12 col-md-12 userprofile">
                                                    <div class="userpic mb-2">
                                                        <img src="{{ url($user->image ? $user->image : 'assets/img/avatar/avatar-3.jpeg') }} " alt="" class="userpicimg"
                                                             id="upload_img">
                                        ...
                                        <div class="form-group col-md-4">
                                            <div class="form-group overflow-hidden">
                                                ...
                                                <select name="type" class="form-control select2 w-100" id="types">
                                                    ...
                                                    <option value="{{ UserTypes::VENDOR }}" {{ $user->type == UserTypes::VENDOR ? "selected": null }}>{{ trans('vendor') }}</option>
                                                    <option value="{{ UserTypes::DRIVER }}" {{ $user->type == UserTypes::DRIVER ? "selected": null }}>{{ trans('driver') }}</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="form-group col-md-4">
                                        ...
                                        <div class="form-group custom-switches-stacked">
                                            ...
                                            <label class="custom-switch">
                                                <input type="radio" name="gender" value="1"
                                                       class="custom-switch-input" {{ (old('gender',$user->gender)== GenderTypes::MALE) ? 'checked' : '' }}>
                                                <span class="custom-switch-indicator"></span>
                                                <span class="custom-switch-description">{{trans('male')}}</span>
                                            </label>
                                            <label class="custom-switch">
                                                <input type="radio" name="gender" value="0"
                                                       class="custom-switch-input" {{ (old('gender',$user->gender)==GenderTypes::FEMALE) ? 'checked' : '' }} >
                                                <span class="custom-switch-indicator"></span>
